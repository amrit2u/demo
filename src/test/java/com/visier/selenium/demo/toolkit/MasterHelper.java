...
public abstract class MasterHelper {
	...
	public void setTimeout(TimeoutType type, long time, TimeUnit unit) {
		...
		if (getWebdriver() != null) {
			...
			throw new TestVisierException("Webdriver is not initialized");
    ...
    public void switchToFrame(WebElement element)
    {
    	try {
    		...
    		throw new TestVisierException("Couldn't switch to frame of element: ");
    	}
	...
	public void isAlertExpected(boolean alertexpect) {
		try {
			...
			if (!alertexpect) {
				throw new TestVisierException("Unexpected Alert Found : '"
						+ alert.getText() + "'");
			}
		} catch (NoAlertPresentException e) {

			if (alertexpect) {
				throw new TestVisierException("Expected Alert Not Found");
			}
		}
	}
	...
	public void waitAndClick(WebElement element) {
		...
		try {
			...
			throw new TestVisierException("Explicit timeout after: "
					+ m_explicit_timeout);
		}
